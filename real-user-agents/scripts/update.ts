...
const slabData: ISlabData = {
  ...
  chromiumBuildVersions: JSON.parse(
    Fs.readFileSync(`${slabBasicsDir}/chromiumBuildVersions.json`, 'utf8'),
  ),
  browserReleaseDates: JSON.parse(
    Fs.readFileSync(`${slabBasicsDir}/browserReleaseDates.json`, 'utf8'),
  ),
  ...
  darwinToMacOsVersionMap: JSON.parse(
    Fs.readFileSync(`${slabBasicsDir}/darwinToMacOsVersionMap.json`, 'utf8'),
  ),
  macOsNameToVersionMap: JSON.parse(
    Fs.readFileSync(`${slabBasicsDir}/macOsNameToVersionMap.json`, 'utf8'),
  ),
  macOsVersionAliasMap: JSON.parse(
    Fs.readFileSync(`${slabBasicsDir}/macOsVersionAliasMap.json`, 'utf8'),
  ),
  winOsNameToVersionMap: JSON.parse(
    Fs.readFileSync(`${slabBasicsDir}/winOsNameToVersionMap.json`, 'utf8'),
  ),
};
