      ...
      for (const url of urls) {
        queue.add(async () => {
          ...
          try {
            ...
            await driver.findElement(webdriver.By.css('#start.ready')).click();
            await driver.findElement(webdriver.By.css('#results.ready')).click();
            await driver.wait(until.urlMatches(/headers\.ulixee\.org*/));
          } finally {
            await driver.quit();
          }
        });
